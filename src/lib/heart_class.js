...
const ThreeBezierCurveClass = require('./threebeziercurve_class.js');
//心形
class HeartClass {
  constructor() {
    // 属性心形是一条对称的贝塞尔曲线
    ...
    this.LeftCurve = new ThreeBezierCurveClass();
    this.RightCurve = new ThreeBezierCurveClass();
