...
class ThreeBezierCurveClass {
  constructor() {
    ...
    this.Point3 = new PointClass(0, 0, this.FixedNumber);
    this.Point4 = new PointClass(0, 0, this.FixedNumber);
  ...
  Set() {
    if (!(_.isUndefined(arguments[0]))) {
      ...
      if (arguments.length == 9) {
        if (_.isNumber(arguments[8])) {
          this.FixedNumber = arguments[8];
        }
        ...
        if ((_.isNumber(arguments[6])) && (_.isNumber(arguments[7]))) {
          this.Point3.Set(parseFloat(arguments[6].toFixed(this.FixedNumber)), parseFloat(arguments[7].toFixed(this.FixedNumber)), this.FixedNumber);
        }
      }
      ...
      if (arguments.length == 8) {
        ...
        if ((_.isNumber(arguments[5])) && (_.isNumber(arguments[6]))) {
          this.Point2.Set(parseFloat(arguments[4].toFixed(this.FixedNumber)), parseFloat(arguments[5].toFixed(this.FixedNumber)), this.FixedNumber);
        }
      }
      if (arguments.length == 5) {
        ...
        if ((_.isArray(arguments[0])) && (_.isArray(arguments[1])) && (_.isArray(arguments[2])) && (_.isArray(arguments[3]))) {
          this.Point1.Set(arguments[0]);
          this.Point2.Set(arguments[1]);
          this.Point3.Set(arguments[2]);
          this.Point4.Set(arguments[3]);
        }
        if ((Common.IsJson(arguments[0])) && (Common.IsJson(arguments[1])) && (Common.IsJson(arguments[2])) && (Common.IsJson(arguments[3]))) {
          this.Point1.Set(arguments[0]);
          this.Point2.Set(arguments[1]);
          this.Point3.Set(arguments[2]);
          this.Point4.Set(arguments[3]);
        }
        if ((PointClass.IsClass(arguments[0])) && (PointClass.IsClass(arguments[1])) && (PointClass.IsClass(arguments[2])) && (PointClass.IsClass(arguments[3]))) {
          this.Point1.Set(arguments[0]);
          this.Point2.Set(arguments[1]);
          this.Point3.Set(arguments[2]);
          this.Point4.Set(arguments[3]);
      ...
      if (arguments.length == 1) {
        if (_.isArray(arguments[0])) {
          if (arguments[0].length == 9) {
            if (!(_.isUndefined(arguments[0][8]))) {
              if (_.isNumber(arguments[0][8])) {
                this.FixedNumber = arguments[0][8];
              }
            }
            ...
            if ((!(_.isUndefined(arguments[0][6]))) && (!(_.isUndefined(arguments[0][7])))) {
              if ((_.isNumber(arguments[0][6])) && (_.isNumber(arguments[0][7]))) {
                this.Point3.Set(arguments[0][6], arguments[0][7], this.FixedNumber);
              }
            }
          }
          ...
          if (arguments[0].length == 5) {
            ...
            if ((_.isArray(arguments[0][0])) && (_.isArray(arguments[0][1])) && (_.isArray(arguments[0][2])) && (_.isArray(arguments[0][3]))) {
              this.Point1.Set(arguments[0][0]);
              this.Point2.Set(arguments[0][1]);
              this.Point3.Set(arguments[0][2]);
              this.Point4.Set(arguments[0][3]);
            }
            if ((Common.IsJson(arguments[0][0])) && (Common.IsJson(arguments[0][1])) && (Common.IsJson(arguments[0][2])) && (Common.IsJson(arguments[0][3]))) {
              this.Point1.Set(arguments[0][0]);
              this.Point2.Set(arguments[0][1]);
              this.Point3.Set(arguments[0][2]);
              this.Point4.Set(arguments[0][3]);
            }
            if ((PointClass.IsClass(arguments[0][0])) && (PointClass.IsClass(arguments[0][1])) && (PointClass.IsClass(arguments[0][2])) && (PointClass.IsClass(arguments[0][3]))) {
              this.Point1.Set(arguments[0][0]);
              this.Point2.Set(arguments[0][1]);
              this.Point3.Set(arguments[0][2]);
              this.Point4.Set(arguments[0][3]);
        ...
        if (Common.IsJson(arguments[0])) {
          ...
          if (!(_.isUndefined(arguments[0].Point1))) {
            this.Point1.Set(arguments[0].Point1);
          }
          if (!(_.isUndefined(arguments[0].Point2))) {
            this.Point2.Set(arguments[0].Point2);
          }
          if (!(_.isUndefined(arguments[0].Point3))) {
            this.Point3.Set(arguments[0].Point3);
          }
          if (!(_.isUndefined(arguments[0].Point4))) {
            this.Point4.Set(arguments[0].Point4);
          }
        }
  ...
  //生成一个克隆体
  Clone() {
    var aNewClass = new ThreeBezierCurveClass(this);
    return aNewClass;
  }
  //仅仅判断XY
  Equal(el) {
  ...
  //判断是否线类
  IsClass(e) {
    return e instanceof ThreeBezierCurveClass;
  }
  ...
  Translate() {
    if (!(_.isUndefined(arguments[0]))) {
      if (arguments.length == 2) {
        ...
        this.Point3.Translate(arguments[0], arguments[1]);
        this.Point4.Translate(arguments[0], arguments[1]);
      }
      if (arguments.length == 1) {
        if (Common.IsJson(arguments[0])) {
          this.Point1.Translate(arguments[0].X, arguments[0].Y);
          this.Point2.Translate(arguments[0].X, arguments[0].Y);
          this.Point3.Translate(arguments[0].X, arguments[0].Y);
          this.Point4.Translate(arguments[0].X, arguments[0].Y);
        }
        if (_.isArray(arguments[0])) {
          this.Point1.Translate(arguments[0][0], arguments[0][1]);
          this.Point2.Translate(arguments[0][0], arguments[0][1]);
          this.Point3.Translate(arguments[0][0], arguments[0][1]);
          this.Point4.Translate(arguments[0][0], arguments[0][1]);
        }
        if (PointClass.IsClass(arguments[0])) {
          this.Point1.Translate(arguments[0]);
          this.Point2.Translate(arguments[0]);
          this.Point3.Translate(arguments[0]);
          this.Point4.Translate(arguments[0]);
        }
      }
    }
    return this;
    ...
    if (!(_.isUndefined(arguments[0]))) {
      ...
      if (arguments.length == 1) {
        if (Common.IsJson(arguments[0])) {
          ...
          this.Point3.Add(arguments[0].X, arguments[0].Y);
          this.Point4.Add(arguments[0].X, arguments[0].Y);
        }
        if (_.isArray(arguments[0])) {
          this.Point1.Add(arguments[0][0], arguments[0][1]);
          this.Point2.Add(arguments[0][0], arguments[0][1]);
          this.Point3.Add(arguments[0][0], arguments[0][1]);
          this.Point4.Add(arguments[0][0], arguments[0][1]);
        }
        if (PointClass.IsClass(arguments[0])) {
  ...
  //获取斜率
  GetSlope() {
    if (this.Point1.X == this.Point4.X) {
      return false;
    }
    return parseFloat(((this.Point4.Y - this.Point1.Y) / (this.Point4.X - this.Point1.X)).toFixed(this.FixedNumber));
  }
  //获取角度
  GetAngle() {
    var idiff_x = this.Point4.X - this.Point1.X;
    var idiff_y = this.Point4.Y - this.Point1.Y;
    //返回角度,不是弧度
    if (idiff_x != 0) {
...
module.exports = ThreeBezierCurveClass;